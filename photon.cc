...
public:
  ...
  bool passIDcuts( int iEvent , int iPhoton ){
   ...
   double ChargedIsoRhoCorr( int iEvent , int iPhoton , double rho){
   ...
   double NeutralIsoRhoCorr( int iEvent , int iPhoton , double rho){
  ...
  return nuIso;
   ...
   double PhotonIsoRhoCorr( int iEvent , int iPhoton , double rho){
