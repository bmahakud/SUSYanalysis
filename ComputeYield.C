...
void ComputeYield(TString process ="GJets400HT600" ){//main programme
...
if(process=="GJets400HT600"){
  ...
  TString outputFile = "yields_GJets400HT600_RA2b_72bin.root";
  ...
  TString outputFile = "yields_GJets600HTInf_RA2b_72bin.root";
  bool photonEfficiencies = true;
  TChain* t = new TChain("TreeMaker2/PreSelection");
  ...
  TString outputFile = "yields_ZJetsToNuNu400HT600_RA2b_72bin.root";
  ...
  TString outputFile = "yields_ZJetsToNuNu600HTInf_RA2b_72bin.root";
  bool photonEfficiencies = false;
  TChain* t = new TChain("TreeMaker2/PreSelection");
