...
ZgamRatio.GetYaxis().SetRangeUser(0,1.5)
...
can3.SaveAs("ZgamRatio24bin.png")
...
can7.SaveAs("ZgamRatio_njets24bin.png")
...
can8.SaveAs("ZgamRatio_btags24bin.png")
...
can5.SaveAs("ZgamRatio_MHT24bin.png")
...
can6.SaveAs("ZgamRatio_HT24bin.png")
...
for zn in range(1,25):
    for zNj in range(0,3):
        effAcc_72binfrom24bin.SetBinContent(zn+24*zNj,effAcc.GetBinContent(zn))
        effAcc_72binfrom24bin.SetBinError(zn+24*zNj,effAcc.GetBinError(zn))
        effID_72binfrom24bin.SetBinContent(zn+24*zNj,effID.GetBinContent(zn))
        effID_72binfrom24bin.SetBinError(zn+24*zNj,effID.GetBinError(zn))
        effISO_72binfrom24bin.SetBinContent(zn+24*zNj,effISO.GetBinContent(zn))
        effISO_72binfrom24bin.SetBinError(zn+24*zNj,effISO.GetBinError(zn))   
...
can4.SaveAs("closureTest24bin.png")
