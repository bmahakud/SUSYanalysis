...
/////////////////////////////////METsig
   ...
   /////////////////////////////////////////MHT         
           ...
           bkg_MHT_Wjetlnu->SetLineWidth(2);     
            ...
            sig_MET_T1tttt->Scale(0.0017);
            bkg_MET_QCD500->Scale(5.582);
            bkg_MET_QCD1000->Scale(0.307);
            bkg_MET_ttbar->Scale(0.0816);
            bkg_MET_Ztonunu->Scale(0.1237);
            bkg_MET_Wjetlnu->Scale(0.1222);

            sig_METsig_T1tttt->Scale(0.0017);
            bkg_METsig_QCD500->Scale(5.582);
            bkg_METsig_QCD1000->Scale(0.307);
            bkg_METsig_ttbar->Scale(0.0816);
            bkg_METsig_Ztonunu->Scale(0.1237);
            bkg_METsig_Wjetlnu->Scale(0.1222);

            sig_MHT_T1tttt->Scale(0.0017);
            bkg_MHT_QCD500->Scale(5.582);
            bkg_MHT_QCD1000->Scale(0.307);
            bkg_MHT_ttbar->Scale(0.0816);
            bkg_MHT_Ztonunu->Scale(0.1237);
            bkg_MHT_Wjetlnu->Scale(0.1222);
///////////////////////////adding QCD histos
