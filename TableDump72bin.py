...
print "======Z/gamma ratio======="
ZgamRatio = TH1F(GJets)
ZgamRatio.SetNameTitle("ZgamRatio","ZgamRatio")
computeRatio(ZgamRatio,Zinv,GJets)
ZgamRatio.GetXaxis().SetTitle("i^{th} Bin")
ZgamRatio.GetYaxis().SetTitle("Z/#gamma Ratio")
for i in range(Zinv.GetNbinsX()):
    print i,":",Zinv.GetBinContent(i),"/",GJets.GetBinContent(i),"=",ZgamRatio.GetBinContent(i)


for ii in range(ZgamRatio.GetNbinsX()):
     print "bibhu's bin content = ", ZgamRatio.GetBinContent(ii) 
...
can3.SaveAs("ZgamRatio72bin.png")
...
can7.SaveAs("ZgamRatio_njets72bin.png")
...
can8.SaveAs("ZgamRatio_btags72bin.png")
...
can5.SaveAs("ZgamRatio_MHT72bin.png")
...
can6.SaveAs("ZgamRatio_HT72bin.png")
...
can4.SaveAs("closureTest72bin.png")
