...
ZgamRatio_72binfrom18bin = TH1F("ZmR72", "ZmR72bin", 72, 0.5, 72.5)
effAcc_72binfrom18bin = TH1F("effAcc72", "effAc72bin", 72, 0.5, 72.5)
effID_72binfrom18bin = TH1F("effID72", "effID72bin", 72, 0.5, 72.5)
effISO_72binfrom18bin = TH1F("effISOR72", "effISO72bin", 72, 0.5, 72.5)





fGJets400_18bin = TFile("yields_GJets400HT600_RA2b_18bin.root")
fGJets600_18bin = TFile("yields_GJets600HTInf_RA2b_18bin.root")
fZinv400_18bin = TFile("yields_ZJetsToNuNu400HT600_RA2b_18bin.root")
fZinv600_18bin = TFile("yields_ZJetsToNuNu600HTInf_RA2b_18bin.root")

Zinv400_18bin = TH1F( fZinv400_18bin.Get("gen") )
Zinv400_18bin.SetNameTitle("Zinv400_18bin","Zinv400_18bin")
Zinv600_18bin = TH1F( fZinv600_18bin.Get("gen") )
Zinv600_18bin.SetNameTitle("Zinv600_18bin","Zinv600_18bin")

Zinv_18bin = TH1F( Zinv400_18bin )
Zinv_18bin.SetNameTitle("Zinv_18bin","Zinv_18bin")
combineSamples(Zinv_18bin,Zinv400_18bin,0.0285176076,Zinv600_18bin,0.0095394927)


GJets400_18bin = TH1F( fGJets400_18bin.Get("gen") )
GJets400_18bin.SetNameTitle("GJets400_18bin","GJets400_18bin")
GJets600_18bin = TH1F( fGJets600_18bin.Get("gen") )
GJets600_18bin.SetNameTitle("GJets600_18bin","GJets600_18bin")

GJets_18bin = TH1F( GJets400_18bin )
GJets_18bin.SetNameTitle("GJets_18bin","GJets_18bin")
combineSamples(GJets_18bin,GJets400_18bin,0.150303926,GJets600_18bin,0.0546995625)


GJets_18bin.SetLineWidth(2)
GJets_18bin.SetLineStyle(2)
GJets_18bin.SetLineColor(6)
GJets_18bin.DrawNormalized("hist")

Zinv_18bin.SetLineWidth(2)
Zinv_18bin.SetLineStyle(1)
Zinv_18bin.SetLineColor(4)
Zinv_18bin.DrawNormalized("hist,same")
...
combineSamples(Zinv,Zinv400,0.0285176076,Zinv600,0.0095394927)
...
combineSamples(GJets,GJets400,0.150303926,GJets600,0.0546995625)
...
GJets_acc400 = TH1F( fGJets400_18bin.Get("accepted") )
GJets_acc400.SetNameTitle("GJets_acc400","GJets_acc400")
GJets_acc600 = TH1F( fGJets600_18bin.Get("accepted") )
GJets_acc600.SetNameTitle("GJets_acc600","GJets_acc600")

GJets_acc = TH1F( fGJets400_18bin.Get("accepted") )
GJets_acc.SetNameTitle("GJets_acc","GJets_acc")
combineSamples(GJets_acc,GJets_acc400,0.150303926,GJets_acc600,0.0546995625)

GJets_id400 = TH1F( fGJets400_18bin.Get("IDed") )
GJets_id400.SetNameTitle("GJets_id400","GJets_id400")
GJets_id600 = TH1F( fGJets600_18bin.Get("IDed") )
GJets_id600.SetNameTitle("GJets_id600","GJets_id600")

GJets_id = TH1F( fGJets400_18bin.Get("IDed") )
GJets_id.SetNameTitle("GJets_id","GJets_id")
combineSamples(GJets_id,GJets_id400,0.150303926,GJets_id600,0.0546995625)

GJets_iso400 = TH1F( fGJets400_18bin.Get("ISOed") )
GJets_iso400.SetNameTitle("GJets_iso400","GJets_iso400")
GJets_iso600 = TH1F( fGJets600_18bin.Get("ISOed") )
GJets_iso600.SetNameTitle("GJets_iso600","GJets_iso600")

GJets_iso = TH1F( fGJets400_18bin.Get("ISOed") )
GJets_iso.SetNameTitle("GJets_id","GJets_iso")
combineSamples(GJets_iso,GJets_iso400,0.150303926,GJets_iso600,0.0546995625)


GJets_iso400_72bin = TH1F( fGJets400.Get("ISOed") )
GJets_iso400_72bin.SetNameTitle("GJets_iso400","GJets_iso400")
GJets_iso600_72bin = TH1F( fGJets600.Get("ISOed") )
GJets_iso600_72bin.SetNameTitle("GJets_iso600","GJets_iso600")

GJets_iso_72bin = TH1F( fGJets400.Get("ISOed") )
GJets_iso_72bin.SetNameTitle("GJets_id","GJets_iso")
combineSamples(GJets_iso_72bin,GJets_iso400_72bin,0.150303926,GJets_iso600_72bin,0.0546995625)
...
effAcc.Divide(GJets_acc,GJets_18bin,1.,1.,"B")
...
gPad.SetLogy()
GJets_18bin.Draw("hist,e1")
GJets_acc.Draw("hist,e1,SAME")
GJets_id.Draw("hist,e1,SAME")
GJets_iso.Draw("hist,e1,SAME")

print "======Z/gamma ratio======="
ZgamRatio = TH1F(GJets_18bin)
ZgamRatio.SetNameTitle("ZgamRatio","ZgamRatio")
computeRatio(ZgamRatio,Zinv_18bin,GJets_18bin)
ZgamRatio.GetXaxis().SetTitle("i^{th} Bin")
ZgamRatio.GetYaxis().SetTitle("Z/#gamma Ratio")
for i in range(Zinv_18bin.GetNbinsX()):
    print i,":",Zinv_18bin.GetBinContent(i),"/",GJets_18bin.GetBinContent(i),"=",ZgamRatio.GetBinContent(i)

ZgamRatio.GetYaxis().SetRangeUser(0,1)
...
can3.SaveAs("ZgamRatio18bin.png")
...
GJets_njets2D.Scale(0.150303926)
GJets_njets2D.Add(GJets600_njets,0.0546995625)
...
Zinv_njets2D.Scale(0.0285176076)
Zinv_njets2D.Add(Zinv600_njets,0.0095394927)
...
ZgamR_njets.GetYaxis().SetRangeUser(0,1)

ZgamR_njetsPad.cd()
ZgamR_njets.Draw("e1")

can7.SaveAs("ZgamRatio_njets.eps")
can7.SaveAs("ZgamRatio_njets18bin.png")
...
GJets_btags2D.Scale(0.150303926)
GJets_btags2D.Add(GJets600_btags,0.0546995625)
...
Zinv_btags2D.Scale(0.0285176076)
Zinv_btags2D.Add(Zinv600_btags,0.0095394927)
...
ZgamR_btags.GetYaxis().SetRangeUser(0,1)

ZgamR_btagsPad.cd()
ZgamR_btags.Draw("e1")

can8.SaveAs("ZgamRatio_btags.eps")
can8.SaveAs("ZgamRatio_btags18bin.png")
...
GJets_MHT.Scale(0.150303926)
GJets_MHT.Add(GJets600_MHT,0.0546995625)
...
Zinv_MHT.Scale(0.0285176076)
Zinv_MHT.Add(Zinv600_MHT,0.0095394927)
...
ZgamR_MHT.GetYaxis().SetRangeUser(0,1)

ZgamR_MHTPad.cd()
ZgamR_MHT.Draw("e1")

can5.SaveAs("ZgamRatio_MHT.eps")
can5.SaveAs("ZgamRatio_MHT18bin.png")
...
GJets_HT.Scale(0.150303926)
GJets_HT.Add(GJets600_HT,0.0546995625)
...
Zinv_HT.Scale(0.0285176076)
Zinv_HT.Add(Zinv600_HT,0.0095394927)
...
ZgamR_HT.GetYaxis().SetRangeUser(0,1)

ZgamR_HTPad.cd()
ZgamR_HT.Draw("e1")

can6.SaveAs("ZgamRatio_HT.eps")
can6.SaveAs("ZgamRatio_HT18bin.png")
can6.SaveAs("ZgamRatio_HT.pdf")
##==============================
cTest1 = TCanvas("cTest1","cTest1",500,500);

ZgamRatio_72binfrom18bin.Sumw2()

for nj in range(0,3):
    for bt in range(0,4):
        for ht in range(1,7):
            ZgamRatio_72binfrom18bin.SetBinContent(24*nj+6*bt+ht,ZgamRatio.GetBinContent(6*nj+ht))
            ZgamRatio_72binfrom18bin.SetBinError(24*nj+6*bt+ht,ZgamRatio.GetBinError(6*nj+ht))
            effAcc_72binfrom18bin.SetBinContent(24*nj+6*bt+ht,effAcc.GetBinContent(6*nj+ht))
            effAcc_72binfrom18bin.SetBinError(24*nj+6*bt+ht,effAcc.GetBinError(6*nj+ht))
            effID_72binfrom18bin.SetBinContent(24*nj+6*bt+ht,effID.GetBinContent(6*nj+ht))
            effID_72binfrom18bin.SetBinError(24*nj+6*bt+ht,effID.GetBinError(6*nj+ht))
            effISO_72binfrom18bin.SetBinContent(24*nj+6*bt+ht,effISO.GetBinContent(6*nj+ht))
            effISO_72binfrom18bin.SetBinError(24*nj+6*bt+ht,effISO.GetBinError(6*nj+ht))

#for i in range(ZgamRatio_72binfrom18bin.GetNbinsX()):
  #  print "Loop value",i
   # print "ZgammaRatio(72 bin)in  ",i+1,"th bin",ZgamRatio_72binfrom18bin.GetBinContent(i+1)
  
'''
for bn in range(1,19):
    for jn in range(0,4): 
        ZgamRatio_72binfrom18bin.SetBinContent(bn+18*jn,ZgamRatio.GetBinContent(bn))
        ZgamRatio_72binfrom18bin.SetBinError(bn+18*jn,ZgamRatio.GetBinError(bn))
...
for zn in range(1,19):
    for zNj in range(0,4):
        effAcc_72binfrom18bin.SetBinContent(zn+18*zNj,effAcc.GetBinContent(zn))
        effAcc_72binfrom18bin.SetBinError(zn+18*zNj,effAcc.GetBinError(zn))
        effID_72binfrom18bin.SetBinContent(zn+18*zNj,effID.GetBinContent(zn))
        effID_72binfrom18bin.SetBinError(zn+18*zNj,effID.GetBinError(zn))
        effISO_72binfrom18bin.SetBinContent(zn+18*zNj,effISO.GetBinContent(zn))
        effISO_72binfrom18bin.SetBinError(zn+18*zNj,effISO.GetBinError(zn))   
'''



Zestimate = TH1F(GJets_iso_72bin)
...
Zestimate.Multiply( GJets_iso_72bin , ZgamRatio_72binfrom18bin , 1. , 1. );
Zestimate.Divide( Zestimate , effAcc_72binfrom18bin , 1. , 1. );
Zestimate.Divide( Zestimate , effID_72binfrom18bin , 1. , 1. );
Zestimate.Divide( Zestimate , effISO_72binfrom18bin , 1. , 1. );
...
closRatio.GetYaxis().SetRangeUser(0,2);

closRatio.Draw("p,e1");

can4.SaveAs("closureTest.eps")
can4.SaveAs("closureTest.pdf")
can4.SaveAs("closureTest18bin.png")
...
histoVec = { Zinv : vZinv , 
             ...
             #GJets_id : vGJets_id , 
             GJets_iso_72bin : vGJets_iso , 
             effAcc_72binfrom18bin : veffAcc , 
             effID_72binfrom18bin : veffID , 
             effISO_72binfrom18bin : veffISO , 
             ZgamRatio_72binfrom18bin : vZgamRatio , 
