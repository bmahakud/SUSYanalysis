...
effAcc_72binfrom24bin = TH1F("effAcc72", "effAc72bin", 72, 0.5, 72.5)
effID_72binfrom24bin = TH1F("effID72", "effID72bin", 72, 0.5, 72.5)
effISO_72binfrom24bin = TH1F("effISOR72", "effISO72bin", 72, 0.5, 72.5)





fGJets400_24bin = TFile("yields_GJets400HT600_RA2b_18bin.root")
fGJets600_24bin = TFile("yields_GJets600HTInf_RA2b_18bin.root")
fZinv400_24bin = TFile("yields_ZJetsToNuNu400HT600_RA2b_18bin.root")
fZinv600_24bin = TFile("yields_ZJetsToNuNu600HTInf_RA2b_18bin.root")
...
GJets_acc400 = TH1F( fGJets400_24bin.Get("accepted") )
GJets_acc400.SetNameTitle("GJets_acc400","GJets_acc400")
GJets_acc600 = TH1F( fGJets600_24bin.Get("accepted") )
GJets_acc600.SetNameTitle("GJets_acc600","GJets_acc600")

GJets_acc = TH1F( fGJets400_24bin.Get("accepted") )
...
GJets_id400 = TH1F( fGJets400_24bin.Get("IDed") )
GJets_id400.SetNameTitle("GJets_id400","GJets_id400")
GJets_id600 = TH1F( fGJets600_24bin.Get("IDed") )
GJets_id600.SetNameTitle("GJets_id600","GJets_id600")

GJets_id = TH1F( fGJets400_24bin.Get("IDed") )
...
GJets_iso400 = TH1F( fGJets400_24bin.Get("ISOed") )
GJets_iso400.SetNameTitle("GJets_iso400","GJets_iso400")
GJets_iso600 = TH1F( fGJets600_24bin.Get("ISOed") )
GJets_iso600.SetNameTitle("GJets_iso600","GJets_iso600")

GJets_iso = TH1F( fGJets400_24bin.Get("ISOed") )
...
combineSamples(GJets_iso_72bin,GJets_iso400_72bin,0.075604015773398,GJets_iso600_72bin,0.0261385093009007)
...
effAcc.Divide(GJets_acc,GJets_24bin,1.,1.,"B")
...
for bn in range(1,19):
    for jn in range(0,4): 
        ZgamRatio_72binfrom24bin.SetBinContent(bn+18*jn,ZgamRatio.GetBinContent(bn))
        ZgamRatio_72binfrom24bin.SetBinError(bn+18*jn,ZgamRatio.GetBinError(bn))
...
for zn in range(1,19):
    for zNj in range(0,4):
        effAcc_72binfrom24bin.SetBinContent(zn+18*zNj,effAcc.GetBinContent(zn))
        effAcc_72binfrom24bin.SetBinError(zn+18*zNj,effAcc.GetBinError(zn))
        effID_72binfrom24bin.SetBinContent(zn+18*zNj,effID.GetBinContent(zn))
        effID_72binfrom24bin.SetBinError(zn+18*zNj,effID.GetBinError(zn))
        effISO_72binfrom24bin.SetBinContent(zn+18*zNj,effISO.GetBinContent(zn))
        effISO_72binfrom24bin.SetBinError(zn+18*zNj,effISO.GetBinError(zn))   
...
Zestimate.Multiply( GJets_iso_72bin , ZgamRatio_72binfrom24bin , 1. , 1. );
Zestimate.Divide( Zestimate , effAcc_72binfrom24bin , 1. , 1. );
Zestimate.Divide( Zestimate , effID_72binfrom24bin , 1. , 1. );
Zestimate.Divide( Zestimate , effISO_72binfrom24bin , 1. , 1. );
...
histoVec = { Zinv : vZinv , 
             ...
             effID : veffID , 
             effISO : veffISO , 
             ZgamRatio_72binfrom24bin : vZgamRatio , 
